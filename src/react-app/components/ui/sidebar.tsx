...
import { useIsMobile } from "@/react-app/hooks/use-mobile"
...
import {
  ...
  SheetHeader,
  SheetTitle,
} from "@/react-app/components/ui/sheet"
...
const SIDEBAR_HEADER_HEIGHT = "4rem" // Height of top navbar (h-16 = 64px = 4rem)
    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex min-h-[calc(100svh-4rem)] w-full",
            className
          )}
          {...props}
        >
